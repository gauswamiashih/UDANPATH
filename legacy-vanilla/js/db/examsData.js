/**
 * UDANPATH - Real Live 2025/2026 Indian Competitive Exams Database
 * Accurate 7th Pay Commission Salaries, Updated Age Relaxations & Active Official Links
 */
...
const EXAMS_DATABASE = [
  ...
  },
  {
    ...
    minAge: 17,
    maxAgeGen: 99, // Upper Age Limit Removed by NMC
    ageRelaxation: { OBC: 0, SC: 0, ST: 0, PWD: 0 },
